# Trouvé sur Reddit de '4HbQ' je la trouve trop élégante, je voulais refaire ma soluce mais celle là est trop perfect
import re

a, b, c, *prog = map(int, re.findall(r'\d+', open('jour17/jour17.txt').read()))
